...
import { inquiryEmailSubject, inquiryMessageTemplate } from "@/lib/cloud/message-templates";
...
export function InquiryMessageTemplates({ clientName, inquiryTitle, nextContactOn }: { clientName: string; inquiryTitle: string; nextContactOn: string | null }) {
  ...
  const message = inquiryMessageTemplate({ clientName, inquiryTitle, nextContactOn });
